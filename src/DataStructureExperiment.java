...
public class DataStructureExperiment {
    public static void main(String[] args) {
        ...
        namesAL.add("Fred");
        namesAL.add(new Student(10001,"Fred","Flintstone"));
        ...
        System.out.println("This the stringAL list");
...
//        studentAL.remove(st4);
        ...
        System.out.println("Printing out the HashSet");
        ...
        studentTS.add(st1);
        studentTS.add(st2);
        studentTS.remove(st3);

        System.out.println("Student TreeSet: ");
